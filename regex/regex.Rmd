...
2. **Find only capitalized** words<br>*Some characters don't have a literal meaning, these are known as meta characters:  e.g. `"` or `[`*
...
### Last word
3. **Match the last words of sentences**<br>*We can restore a letter's literal meaning by escaping it*
...
### Section headings
7. Note how `+` can be applied to a group  
