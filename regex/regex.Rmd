...
1. [Open the example RFC text in RegExr](http://www.regexr.com/3c7gi)
    i. `avian` -- 2 matches
    ii. `Avian` -- 12 matches
    iii. `avian` -- with the ignore case flag -- 14 matches
    iv. Clear the case insensitive flag


        
<br> ![](http://www.clipular.com/c/6697213840326656.png?k=Sr4JJIBaQIQrFV_e22vdal35gLk)  ![](http://www.clipular.com/c/5482778819821568.png?k=0ABAsScKdMlMhm02iRyZaI6HTFo)

![](http://www.clipular.com/c/4523633702600704.png?k=2ANfuhKq9-YlXhHskHO6UWvkeZ0)  ![](http://www.clipular.com/c/6101324037881856.png?k=6kHKagztUKV9hfLP2f0z64Euk7E)  ![](http://www.clipular.com/c/5227111764721664.png?k=J7C2jn8BBj9xTRXVugf8d9K2ui0)


### Capitalization & character classes
3. **Find only capitalized** words<br>*Some characters don't have a literal meaning, these are known as meta characters:  e.g. `"` or `[`*
