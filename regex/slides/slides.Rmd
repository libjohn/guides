...
- Or regular character (literal meaning)

--

- `Duke.`

- Matches:  "Duke " and "Dukes", or "Duke1" or "Duke0"

- But not "duke" or "dukes"

- `.` A wildcard that matches every character except a newline
